...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>A prey (with representative range circle) and the hunter turning into its circle to seek it out.</p></figcaption></figure>

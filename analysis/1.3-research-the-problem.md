...
This game features a similar style to Terra Nil in how new creatures are added, using a bar along the base of the screen and allowing the player to drag and drop wherever they like in the world. The main difference I found was that the player has access to a wide variety of different menus, featuring a terrain builder and landscape manipulator. Once again this ability to view what can be added is very useful and I would definitely want to add this, however I would lean more towards Terra Nil's style of a visual representation of what can be added.&#x20;

![](<../.gitbook/assets/image (1) (2) (1).png>)

### World design and the art style

Whilst I love the art style, the game is too realistic for me to duplicate. The art is meant to mimic real life, featuring realistic physics and water interactions, plus uniquely designed fish of both reality and imagination. The overall art style is too advanved for me too copy however the focus on the physics of the game is something I would like to add as I believe it creates a much more realistic environment for the pleyer to exist inside of.&#x20;

### Map and Manager

The game features a map that displays the location of the currently implemented species and a manager that shows the quantity of each. This allows the player to see where the majority of a species may hide out, so that they can provide better care for said fish. The is something I would definitely want to add to my game as I believe that the map creates a fun overview for the player that succintly shows the way that they have made their world and where their creatures are living.&#x20;

### The fun aspect

The game can also be played in a less serious manner, playing a game solely to only have herbivores or to create the strangest animal possible. While this may not be the goal of the game, it can be done and can be funny to both watch and play. This aspect may be less important as it would teach less to the target audience I am going for in [1.2 Stakeholders](1.2-stakeholders.md#stakeholders-overall). However, this would definitely help keep a younger child entertained, as they would have a funny thing to aim for and wouldn't have to take the game as seriously.&#x20;
...
Different to the other games, Equilinox features a large menu that the player opens to choose from a list of plants or animals. This expansive list lets the player select whatever it is they would like to plant or place, and then place wherever they want costing points. It is more like a shop, where the player purchases new things to implement into their word. As previously stated, in a game of this genre an implementation system is a space the player will spend a large portion of their time so it has to be designed well and be smooth. Because of this I believe a shop is a good idea, however it would take a second place to the priorly mentioned implementation bar along the base of the players screen.&#x20;

### World design and art style

From everything I have seen, the world design stays the same for each player, featuring its uniqueness in the absolute control given to the player. It also features a season and environment system, allowing the player to explore a winter world, a swamp or the starter hill and lake. The art style may be my favorite of any of these games, a lovely low poly system that really gets across what each and every animal and plant is whilst still being unique and individual. This would be the art style I would implement. The low quality means it would run on even a browser as is my intentions, whilst still looking stylish and funny.&#x20;

### How the creatures interact with the world

{% embed url="https://youtu.be/XuTXzLZMLUE?t=41" %}
A short [clip ](../reference-list.md)of a bird landing in a tree, using the tree as its nest.&#x20;
{% endembed %}

In this video, at an earlier point you can see a beaver chop the tree down and use it to build its home, altering the world to create for itself. A mountain goat can next be seen hitting a fruit tree to cause it to drop fruit- this world interactivity is something I would hope to add to my game, the ability to watch as what you implement creates change in the world. The part I linked to in the video is something I really liked- a bird landing in a nest it has created in a tree, providing it shelter and a breeding and hatching ground. This tree provides sustenance for the animals that roam the floor below, showing the ecosystem working together. This would be a very large part of the game and as such a very important but difficult to add area. I believe it would be amazing to introduce however it would also be very difficult and therefore could take up too much time for me to add.&#x20;
